...
```json
{
  "categories": [
    ...
    },
    {
      "idCategory": "4",
      "strCategory": "Lamb",
      "strCategoryThumb": "https://www.themealdb.com/image s/category/lamb.png",
...
<table>
    ...
    <tbody>
      <tr>
        <td className="border p-2">idCategory</td>
        <td className="border  p-2">id category of a meal.Usually an integer</td>
        <td className="border p-2">1</td>
      </tr>
      <tr>
        <td className="border p-2">strCategory </td>
        <td className="border p-2">Name of meal</td>
        <td className="border p-2">Beef</td>
      </tr>
      <tr>
        <td className="border p-2">strCategoryThumb</td>
        <td className="border p-2"></td>
        <td className="border p-2"></td>
      </tr>
       <tr>
        <td className="border p-2">strCategoryDescription</td>
