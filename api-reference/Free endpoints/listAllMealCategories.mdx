...
<table>
    ...
    <tbody>
      <tr>
        <td class="border p-2">idCategory</td>
        <td class="border  p-2">id category of a meal.Usually an integer</td>
        <td class="border p-2">1</td>
      </tr>
      <tr>
        <td class="border p-2">strCategory </td>
        <td class="border p-2">Name of meal</td>
        <td class="border p-2">Beef</td>
      </tr>
      <tr>
        <td class="border p-2">strCategoryThumb</td>
        <td class="border p-2"></td>
        <td class="border p-2"></td>
      </tr>
       <tr>
        <td class="border p-2">strCategoryDescription</td>
